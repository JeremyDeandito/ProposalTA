...
\begin{center}
    ...
    {\Large\bfseries PERANCANGAN ULANG ANTARMUKA SISTEM INFORMASI AKADEMIK BERBASIS WEB DENGAN PENDEKATAN \textit{USER CENTERED DESIGN} UNTUK UNIVERSITAS X}\\
     \vspace{4cm}
